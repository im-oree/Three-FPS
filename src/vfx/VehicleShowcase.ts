...
export class VehicleShowcase {
  ...
  update(dt: number): void {
    ...
    for (const v of this.vehicles) {
      ...
      // Face along the tangent of travel. The models are authored -Z forward,
      // so lookAt at the NEXT orbit point gives correct heading directly.
      ...
      // Bank into the turn — a flat aircraft on a circular path reads wrong.
      v.model.rotateZ(-0.22);
    }
  }
}
